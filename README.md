Here is the final **all-in-one** text. You can copy this entire block directly into your `README.md` file.

I have removed the manual configuration blocks and troubleshooting sections to keep it clean, while ensuring the critical library fix (`libpcap`) is right at the top.
